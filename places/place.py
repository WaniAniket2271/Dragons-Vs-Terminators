...
class Place(object):
    ...
    def add_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            if self.dragon is None:
                ...
                # BEGIN 3.2
                if self.dragon.is_container is True and self.dragon.contained_dragon is None and fighter.is_container is False:
                    self.dragon.contain_dragon(fighter)
                elif self.dragon.is_container is False and fighter.is_container is True :
    ...
    def remove_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            ...
            # BEGIN 4.3
            "*** YOUR CODE HERE ***"
            if isinstance(fighter,DragonKing):
                if fighter.instantiated == False:
